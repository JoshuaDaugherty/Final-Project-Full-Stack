...
export default function BugListItem({bug, handleConfirmDelete, auth}){
 ...
 return (
  <>
  <div className="col-md-4" key={bug._id}>
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          ...
          <div className="modal-footer">
            ...
            <button type="button" className="btn btn-danger" onClick={(evt) => handleConfirmDelete(evt, bug._id)}>Close</button>
          </div>
        </div>
      </div>
    </div>
